#!/usr/bin/env python3
"""Install the execute-simple-task skill and its Codex worker profile."""
...
SKILL_NAME = "execute-simple-task"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Install the execute-simple-task Codex skill and worker profile."
    )
    parser.add_argument(
        "--project",
        action="store_true",
    ...
    # Check conflicts before copying so a normal install does not leave only one
    # half updated.
    skill_conflict = (
